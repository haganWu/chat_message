...
class DefaultMessageWidget extends StatelessWidget {
  ...
  const DefaultMessageWidget({required GlobalKey key, required this.messageModel, this.fontFamily, this.fontSize = 12, this.avatarSize = 28, this.textColor, this.backgroundColor}) : super(key: key);
